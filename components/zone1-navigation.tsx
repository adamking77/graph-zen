...
export function Zone1Navigation({ activeSection, onSectionChange, onExportClick }: Zone1NavigationProps) {
  ...
  return (
    <nav 
      className={`h-full bg-card/95 shadow-[inset_-1px_0_2px_rgba(0,0,0,0.12)] transition-all duration-200 ease-in-out flex flex-col ${isExpanded ? 'zone1-expanded' : 'zone1-collapsed'}`}
    >
      {/* Header */}
